            ...
            <div className="main_team">
              <div className="sub_team p-3">
                ...
                <p className="text-center">
                  ...
                  <br></br> been our founder and head baker since day one aker
                  since day one..
                </p>
              ...
              <div className="sub_team p-3">
                ...
                <p className="text-center">
                  ...
                  well <br></br>as heading up the bakery's marketing aker since
                  day one. initiatives.
                </p>
                <div className="icon_team">
                  <i class="fa-brands fa-facebook-f p-2"></i>
              ...
              <div className="sub_team p-3">
                ...
                <p className="text-center">
                  ...
                  <br></br>including weddings, parties, showers and more.
                </p>
                <div className="icon_team">
                  <i class="fa-brands fa-facebook-f p-2"></i>
                  <i class="fa-brands fa-twitter p-2"></i>
